...
export default function Login() {
  ...
  return (
    ...
    <View className="relative items-start justify-start w-full mt-3">
          ...
          <TextInput className={`mt-3 border-[1px] border-[#D0D5DD] rounded-lg h-12 w-full text-base font-['regular'] text-[#344054] 
          pl-5 ${touched.password && errors.password && 'border-red-500'} ${touched.password && !errors.password && 'border-[#0077B6]'}`}
          placeholder='********'
          placeholderTextColor={'#667085'}
    ...
    className={`text-sm text-[#475467] font-['medium'] mt-7 underline`}>Forgot Password?</Text>
