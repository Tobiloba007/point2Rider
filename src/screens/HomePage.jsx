      ...
      <View className="flex flex-row items-center justify-between w-full pt-8">
        <View className="flex flex-row items-center justify-start">
          ...
          <View className="flex items-start ml-4">
            ...
            <Text className={`text-[#101828] text-base font-['bold']`}>
              {user.last_name}
            </Text>
          </View>
        </View>
        ...
        <View className="flex flex-row items-center justify-end">
          ...
          >
            ...
            <View className="absolute top-0 right-0 flex items-center justify-center bg-[#EB5757] h-4 w-4 rounded-full">
              <Text className={`text-[#FFFFFF] text-[11px] font-['bold']`}>
                2
              </Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            className="flex flex-row items-center justify-center w-[94px] h-[36px] rounded-3xl bg-[#F3FFF8] 
                                           border-[1.2px] border-[#475467] ml-3"
          >
            <Octicons name="dot-fill" size={20} color="#27AE60" />
            <Text className={`text-[#475467] text-sm font-['medium'] ml-2`}>
              Online
            </Text>
          </TouchableOpacity>
        </View>
            ...
            return (
              ...
              >
                ...
                <View className="flex flex-row items-start justify-start mt-5">
                  ...
                  <View className="ml-4">
                    <Text className={`text-[#344054] text-base font-['bold']`}>
                      Pick Up
                    </Text>
                    <Text className={`text-[#475467] text-sm font-['medium']`}>
                ...
                {deleted ? (
                  <View className="flex flex-row items-center justify-between w-full mt-8">
                    <TouchableOpacity className="flex items-center justify-center w-full h-11 bg-[#F2F4F7] rounded-lg border-[1px] border-[#D0D5DD]">
                      <Text
                        className={`text-[#667085] text-base font-['bold']`}
                      >
                        Order Declined
                      </Text>
                    </TouchableOpacity>
                  ...
                  <View className="w-full">
                    {acceptOrder !== null ? (
                      <View className="flex flex-row items-center justify-between w-full mt-8">
                        ...
                        <TouchableOpacity
                          onPress={() => handleSingleOrder(item.id)}
                        ...
                        >
                          {loadDetails ? (
                            ...
                            <Text
                              className={`text-[#0077B6] text-base font-['bold']`}
                            >
                              View Details
                            </Text>
                          )}
                      ...
                      <View className="flex flex-row items-center justify-between w-full mt-8">
                        <TouchableOpacity className="flex items-center justify-center w-[48%] h-11 bg-[#F4F4F4] rounded-lg">
                          <Text
